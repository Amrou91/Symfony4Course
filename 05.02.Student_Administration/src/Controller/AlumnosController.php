...
class AlumnosController extends AbstractController
{
    ...
    {
        return $this->render('alumnos/index.html.twig', ['alumnos' => $alumnosRepository->findAll()]);
    }
    ...
    {
        return $this->render('alumnos/show.html.twig', ['alumno' => $alumno]);
    }
    ...
    public function edit(Request $request, Alumnos $alumno): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('alumnos_index', ['id' => $alumno->getId()]);
        }
